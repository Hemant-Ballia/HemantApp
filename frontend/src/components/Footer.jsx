        ...
        <>
            ...
            <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
                <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 px-4">
                    {/* Yahan maine sabhi href ko unke section id (#) se replace kar diya hai */}
                    ...
                    <a href="#projects" className="font-medium text-gray-500 hover:text-black transition-all">
                        Projects
                    </a>
                    <a href="#skills" className="font-medium text-gray-500 hover:text-black transition-all">
                        Stack
                    </a>
                ...
                {/* Social media container: removed the indigo color class */}
                <div className="flex items-center gap-5 mt-8">
                    <a href="#" aria-label="Facebook" className="text-[#1877F2] hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </a>
                    <a href="#" aria-label="Instagram" className="text-[#E4405F] hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" aria-label="LinkedIn" className="text-[#0A66C2] hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" aria-label="Twitter" className="text-[#1DA1F2] hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" aria-label="GitHub" className="text-[#181717] hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="mt-8 text-center px-4">
                    Copyright © {new Date().getFullYear()} <a target="_blank" rel="noopener noreferrer" className="text-black transition-all">Hemant</a>. All rights reserved.
                </p>
            </footer>
        </>
    );
